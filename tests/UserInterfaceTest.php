...
final class UserInterfaceTest extends TestCase
{
     ...
     * 测试正常的 OpenID 获取
     */
    public function testGetOpenIdWithValidData(): void
    {
     ...
     * 测试特殊字符的 OpenID 获取
     */
    public function testGetOpenIdWithSpecialCharacters(): void
    {
        $openId = 'oABCD-_1234@#$%';
        $user = new MockUser(null, $openId);
     ...
     * 测试正常的 UnionID 获取
     */
    public function testGetUnionIdWithValidData(): void
    {
     ...
     */
    public function testGetUnionIdWithNullData(): void
    {
        $user = new MockUser(null, 'openid123', null);
     ...
     * 测试特殊字符的 UnionID 获取
     */
    public function testGetUnionIdWithSpecialCharacters(): void
    {
        $unionId = 'uABCD-_1234@#$%';
        $user = new MockUser(null, 'openid123', $unionId);
     ...
     * 测试正常的头像 URL 获取
     */
    public function testGetAvatarUrlWithValidData(): void
    {
        $avatarUrl = 'https://example.com/avatar.jpg';
        $user = new MockUser(null, 'openid123', 'unionid123', $avatarUrl);
     ...
     * 测试头像 URL 为 null 的情况
     */
    public function testGetAvatarUrlWithNullData(): void
    {
        $user = new MockUser(null, 'openid123', 'unionid123', null);
    ...
    public function testConstructorParameterOrder(): void
    {
        ...
        $user = new MockUser(null, $openId, $unionId, $avatarUrl);
